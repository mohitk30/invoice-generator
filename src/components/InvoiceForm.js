...
import InvoiceHeader from '../appComponents/features/invoiceList/InvoiceHeader';
import {
  setInvoiceNote,
  setInvoiceCurrency,
  setInvoiceTaxRate,
  ...
  selectInvoices
} from '../appComponents/features/invoicesBuilder/invoiceBuilderSlice'
...
const InvoiceForm =()=> {
  ...
  const handleRowDel=(items)=>{
   ...
   const loadPreviousValues=()=>{
     dispatch(setInvoiceDueDate(''))
    dispatch(setInvoiceNumber(1))
    dispatch(setInvoiceTo(''))
    dispatch(setInvoiceToEmail(''))
    dispatch(setInvoiceToAddress(''))
    dispatch(setInvoiceFrom(''))
    dispatch(setInvoiceFromEmail(''))
    dispatch(setInvoiceFromAddress(''))
    dispatch(setInvoiceNote(''))
    dispatch(setInvoiceId('baseid'))
    dispatch(setInvoiceCurrency('$'))
    dispatch(setInvoiceTaxRate(0))
    dispatch(setInvoiceDiscountRate(0))
    ...
    dispatch(setSubTotal(1))
    dispatch(setInvoiceTax(0))
